...
export default function TabLayout() {
  ...
  return (
    <Tabs
      screenOptions={{
        tabBarActiveTintColor: '#ff7f00', // Active tab icon color
        headerShown: false,
      }}>
      <Tabs.Screen
        name="index"
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <View style={[styles.tabBarIconContainer]}>
              <TabBarIcon name={focused ? 'home' : 'home-outline'} color={focused ? '#ff7f00' : color} />
            </View>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <View style={[styles.tabBarIconContainer]}>
              <TabBarIcon name={focused ? 'code-slash' : 'code-slash-outline'} color={focused ? '#ff7f00' : color} />
            </View>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <View style={[styles.tabBarIconContainer]}>
              <TabBarIcon name={focused ? 'person-circle' : 'person-circle-outline'} color={focused ? '#ff7f00' : color} />
            </View>
          ),
        }}
      />
